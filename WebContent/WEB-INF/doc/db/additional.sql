...
create table auth (
	code serial not null unique primary key,
...
insert into auth (role, uid, password) values (1, 'sys01', 'pass01');
insert into auth (role, uid, password) values (2, 'usr11', 'pass11');
